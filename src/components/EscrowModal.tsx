...
export default function EscrowModal({
    ...
    if (mode === 'create') {
      return (
        <div className="flex justify-between items-center">
          <h2 className="text-xl font-bold text-white">Create NFT Escrow</h2>
          <button
            onClick={onClose}
  ...
  const CreateEscrowForm = () => (
    <div className="space-y-6">
        ...
        <div className="flex space-x-4">
          <label className="flex items-center">
            <input
              ...
              className="mr-2"
            />
            <span className="text-white">I'm selling the NFT</span>
          </label>
          <label className="flex items-center">
            <input
              type="radio"
              ...
              className="mr-2"
            />
            <span className="text-white">I'm buying the NFT</span>
          </label>
        </div>
      </div>
      ...
      {/* NFT Details */}
      <div>
        <label className="block text-gray-300 text-sm font-medium mb-2">NFT Contract Address</label>
        <input
          type="text"
          value={nftContract}
      ...
      <div>
        <label className="block text-gray-300 text-sm font-medium mb-2">Price (MON)</label>
        <input
          type="text"
          value={price}
      ...
      <div className="flex space-x-3 pt-4">
        <button
          ...
          className="flex-1 bg-green-600 hover:bg-green-700 disabled:bg-gray-600 disabled:cursor-not-allowed text-white px-4 py-2 rounded-lg font-medium transition-colors"
        >
